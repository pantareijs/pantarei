...
const Director = require('pantarei-director')
const DirectiveAttribute = require('pantarei-directive-attribute')
const DirectiveClassName = require('pantarei-directive-classname')
const DirectiveEvent = require('pantarei-directive-event')
const DirectiveProperty = require('pantarei-directive-property')
const DirectiveRepeat = require('pantarei-directive-repeat')
const DirectiveText = require('pantarei-directive-text')
